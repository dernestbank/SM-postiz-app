  ...
  implements SocialProvider
{
    ...
    const {
      ...
      await fetch('https://www.linkedin.com/oauth/v2/accessToken', {
        ...
        body: new URLSearchParams({
          ...
          refresh_token,
          client_id: linkedinPageClientId(),
          client_secret: linkedinPageClientSecret(),
        }),
      })
    ).json();
  ...
  override async authenticate(params: {
    ...
    body.append('client_id', linkedinPageClientId());
    body.append('client_secret', linkedinPageClientSecret());
